...
# Title: QPSK Transmitter for USRP
...
class first_first(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "QPSK Transmitter for USRP", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("QPSK Transmitter for USRP")
        ...
        self.settings = Qt.QSettings("GNU Radio", "first_first")
        ...
        self.rrc_taps = rrc_taps = firdes.root_raised_cosine(1.0, samp_rate, samp_rate/4, 0.35, 45)
        ...
        self.qtgui_time_sink_x_0 = qtgui.time_sink_c(
            1024, #size
            samp_rate, #samp_rate
            "Combined Qpsk with jammer in time", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_freq_sink_x_1 = qtgui.freq_sink_c(
            ...
            0, #fc
            samp_rate, #bw
            "combined QPSK with jammer in frequency", #name
            1,
            None # parent
        )
        ...
        self.pfb_arb_resampler_xxx_0 = pfb.arb_resampler_ccf(4, taps=rrc_taps, flt_size=32)
        ...
        self.connect((self.pfb_arb_resampler_xxx_0, 0), (self.qtgui_time_sink_x_2, 0))
...
def main(top_block_cls=first_first, options=None):
