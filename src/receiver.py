...
class receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "QPSK Receiver for USRP", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("QPSK Receiver for USRP")
        ...
        self.spectral_file_sink = blocks.file_sink(gr.sizeof_float*1024, '/home/omar/Downloads/SDR/normal_channel.txt', False)
        self.spectral_file_sink.set_unbuffered(False)
        ...
        self.logpwrfft_x_0 = logpwrfft.logpwrfft_c(
            ...
            average=False,
            shift=False)
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(1, firdes.low_pass(1, samp_rate, 250000, 50000), 0, samp_rate)
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(4, 0.01, rrc_taps, 32, 16, 1.5, 1)
        ...
        self.connect((self.logpwrfft_x_0, 0), (self.spectral_file_sink, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.freq_xlating_fir_filter_xxx_0.set_taps(firdes.low_pass(1, self.samp_rate, 250000, 50000))
